            ...
            { "offline", {
                                    ...
                                    { "result", {
                                                        { "mesh_details", {
                                                                                  ...
                                                                                  { "h_min_coarse", mesh_details.h_min_coarse },
                                                                                  { "h_max_coarse", mesh_details.h_max_coarse },
                                                                                  { "h_min_fine", mesh_details.h_min_fine },
                                                                                  { "h_max_fine", mesh_details.h_max_fine }
                                                                          }},
                                                        { "timing", {
...
std::unique_ptr<Experiment> make_experiment(const std::string & name)
{
    ...
    } else if (name == "quasi_uniform_standard_l_shaped") {
        return std::make_unique<QuasiUniformStandardLShaped>();
    } else {
